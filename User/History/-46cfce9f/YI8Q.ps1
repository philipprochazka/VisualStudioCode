...
Set-Alias l "ls"
Set-Alias ll "ls -la"
Set-Alias -Name less -Value Invoke-Expression $env"C:\Users\philip\Documents\PowerShell\Scripts\less.ps1" -Option AllScope

New-alias Tempa -value Invoke-Expression $env"C:\Users\philip\Documents\PowerShell\Scripts\TempA.ps1"
...
New-alias Tempp Invoke-Expression $env"Start-Process -filepath "C:\Users\philip\Documents\Templates-Drawing_and_VsCode\Print-Layouts""
# Set-Alias cd "z"

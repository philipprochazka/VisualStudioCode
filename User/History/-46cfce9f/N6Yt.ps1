...
Set-Alias l "ls"
Set-Alias ll "ls -la"
Set-Alias dirl "$host{"dir" | "out-host -paging"}"
dir-alias <TempD> "[<"C:\Users\philip\Documents\Templates Drawing & VsCode\Project-Tree-Templates(Project-type specific)"] [-c <start . >]"
# Set-Alias cd "z"

...
• Please copy the Origin_README.md in this folder, rename it to the language's corresponding ISO code (e.g. README_zh_CN.md), then commit the README translated.
...
• If you need any help, please join our [Discord server](https://discord.atlasos.net).

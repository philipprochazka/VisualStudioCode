...
--------------------------------------------------------------------------------------------------------------------------
well so theotetically i could for now routing in JS because it will be faster to get going and store it in routers and later on i can add php also in the same folder or make subfolders for each of them
